...
public class SimpleAES
{
    ...
    private const string initVector = "h6jdg3jfy7oeif73";
...
public class SaveSystem : MonoBehaviour
{
    ...
    protected static string encryptKey = "hjtushd737fj82hsejtis916";
    protected static string savePath = "/lifeclicker.save";
    protected static string savePathBackUP = "/lifeclickerbackup.save";
    ...
    public void ImportPlayer2(MainScript playerData)
    {
